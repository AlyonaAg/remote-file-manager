...
static const RPC_CLIENT_INTERFACE interface_BSIT___RpcClientInterface =
    {
...
RPC_IF_HANDLE interface_BSIT_v1_0_c_ifspec = (RPC_IF_HANDLE)& interface_BSIT___RpcClientInterface;

extern const MIDL_STUB_DESC interface_BSIT_StubDesc;

static RPC_BINDING_HANDLE interface_BSIT__MIDL_AutoBindHandle;
    ...
    /* [out] */ unsigned char *result)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&interface_BSIT_StubDesc,
                  (PFORMAT_STRING) &interface_BSIT__MIDL_ProcFormatString.Format[0],
    ...
    /* [out] */ unsigned char *result)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&interface_BSIT_StubDesc,
                  (PFORMAT_STRING) &interface_BSIT__MIDL_ProcFormatString.Format[46],
                  ( unsigned char * )&path);
    ...
    /* [out] */ unsigned char *result)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&interface_BSIT_StubDesc,
                  (PFORMAT_STRING) &interface_BSIT__MIDL_ProcFormatString.Format[94],
                  ( unsigned char * )&path);
    ...
    /* [out] */ unsigned char *result)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&interface_BSIT_StubDesc,
                  (PFORMAT_STRING) &interface_BSIT__MIDL_ProcFormatString.Format[142],
                  ( unsigned char * )&path);
    ...
    /* [out] */ unsigned char *result)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&interface_BSIT_StubDesc,
                  (PFORMAT_STRING) &interface_BSIT__MIDL_ProcFormatString.Format[178],
...
static const MIDL_STUB_DESC interface_BSIT_StubDesc = 
    {
    (void *)& interface_BSIT___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &IDL_handle,
    0,
